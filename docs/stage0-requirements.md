...
> 작성일: 2026-09-24 (KST) · 상태: **승인됨 (결정 위임 → 아래 7장 기본값 적용)**
...
## 7. 확정 결정 (2026-09-24, 사용자 위임에 따라 기본값 적용)

| #   | 질문             | 결정                                                                                          | 근거                                                                     |
| --- | ---------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| D1  | UI 프레임워크    | **Preact + signals**                                                                          | React 호환 문법, 최소 번들                                               |
| D2  | 교회 문장 저작권 | **직접 작성한 문장 + 퍼블릭 도메인 WEB(World English Bible) 구절만**                          | ESV/NIV는 라이선스 조건 필요 → 배제. KJV는 고어체라 회화 섀도잉에 부적합 |
| D3  | 한국어 번역      | **`ko` 필드 포함** (선택 표시)                                                                | 의미 이해 후 섀도잉이 효과적                                             |
| D4  | UI 언어          | **한국어 UI**, 학습 문장은 영어                                                               | 주 사용자 모국어                                                         |
| D5  | GitHub Pages     | 워크플로 작성. **저장소가 private이면 Pages는 유료 플랜 필요** → Stage 5에서 공개 여부 재확인 | 저장소 공개 전환은 사용자 권한                                           |
| D6  | 자가채점 폴백    | **MVP 포함**                                                                                  | 음성인식 미지원/오프라인(R1·R2·R3) 대비                                  |
| D7  | 무음 연습 모드   | MVP 범위 밖 → 후속 백로그                                                                     | 범위 통제                                                                |
